 ...
 */
 ...
 [_COLEMAK_DH] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_D,   KC_V, _COPIAR,               _PEGAR,  KC_K,    KC_H,    TD(TD_MAX), TD(TD_MIN),  TD(TD_SLA),  KC_RCTL,
 ...
 */
 ...
 [_BAJA] = LAYOUT(
  ...
  _______, KC_EXLM, KC_AT, KC_HASH, KC_DLR,KC_PERC,            KC_PLUS, KC_AMPR, KC_LPRN, KC_RPRN, KC_ASTR, _______,
  _______,KC_1,  KC_2,  KC_3, KC_4, KC_5,                      KC_MINUS, KC_UNDS, KC_LCBR, KC_RCBR,KC_CIRC , KC_PIPE,
  _______, KC_0, KC_9, KC_8, KC_7, KC_6, _______,      _______,  KC_EQL, KC_GRV , KC_LBRC , KC_RBRC,KC_TILD ,_______, 
...
[_ALTA] = LAYOUT(
  ...
  _______,  _______,  KC_HOME, KC_UP,  KC_PGUP, _______,                       _______,    KC_MPRV,    KC_MPLY,    KC_MNXT,_______,  _______,
  _______,  _______, KC_LEFT, KC_DOWN,   KC_RIGHT, _______,              _______, KC_VOLD, KC_VOLU, KC_MSEL,XXXXXXX, XXXXXXX,
  _______, _______, _______, _______,  KC_PGDN,  _______,   _______, _______,  _______, KC_BRID, KC_BRIU,  _______, _______, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST+&()*\|^==///////////
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_MOUSE] = LAYOUT(
  ...
  XXXXXXX, KC_MS_ACCEL1, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,              _MAIL, KC_WH_L, KC_WH_D, KC_WH_R, KC_MS_ACCEL0, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, _SCREEN, XXXXXXX, KC_BTN1, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN, _FLASH, KC_SLEP, KC_PWR, XXXXXXX,
                             _______, _______, _______, _______, _______,  _______, _______, _______
  )
}
